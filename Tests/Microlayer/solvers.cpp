  ...
  /* phase change */
  PhaseChange4 pc(mdot, mflx, tpr.fine, q.fine, c.fine, g.fine , f.fine , uvw.fine, conc_fine.topo,
                  tsat, time, &mixed.fine, &solid.fine, &enthFD_fine.heat_transfer_wall_model());
