...
main(int argc, char * argv[]) {
  ...
  +--------------------------------*/
  boil::plot = new PlotGMV(AsNodes::yes());
  ...
  Times time(1280, 0.00004); /* ndt, dt */
...
//}
  ...
  bubbles.add( Particle( Position( -offst, -offst, -LZ/2.0 + 3.5*D3), Diameter(D3) ) );
  bubbles.add( Particle( Position(  offst, -offst, -LZ/2.0 + 3.0*D3), Diameter(D3) ) );
  bubbles.add( Particle( Position(  offst,  offst, -LZ/2.0 + 2.5*D3), Diameter(D3) ) );
  bubbles.add( Particle( Position( -offst,  offst, -LZ/2.0 + 2.0*D3), Diameter(D3) ) );
  c_bub.exchange();
//droplets.add( Particle( Position( -offst, -offst, +LZ/2.0 - 2.0*D3), Diameter(D0) ) );
//droplets.add( Particle( Position(  offst, -offst, +LZ/2.0 - 2.0*D3), Diameter(D1) ) );
//droplets.add( Particle( Position(  offst,  offst, +LZ/2.0 - 2.0*D3), Diameter(D2) ) );
//droplets.add( Particle( Position( -offst,  offst, +LZ/2.0 - 2.0*D3), Diameter(D3) ) );
  c_dro.exchange();

  boil::plot->plot(uvw, c_sep, c_bub, c_dro, "uvw-phases",  time.current_step());
...
/*-----------------------------------------------------------------------------+
 '$Id: main-rising-bubbles.cpp,v 1.1 2013/08/15 21:27:50 niceno Exp $'/
+-----------------------------------------------------------------------------*/
