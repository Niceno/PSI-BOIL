...
/******************************************************************************/
void Lagrangian::rebounce(int pa, int pb) {
  ...
  real mass_a = flu->rho(lagrangian) * particles[pa].volume();
  real mass_b = flu->rho(lagrangian) * particles[pb].volume();
...
/*-----------------------------------------------------------------------------+
 '$Id: lagrangian_rebounce.cpp,v 1.1 2018/06/15 11:39:11 MinZhu Exp $'/ 
+-----------------------------------------------------------------------------*/
