...
/******************************************************************************/
void Lagrangian::couple_interface() {
/*-------------------------------------------------+
|  couple lagrangian phase with interface tracking |                                              
+-------------------------------------------------*/
  ...
  for_p(p) {
    ...
    for_pijk(p, i, j, k) { // browse in particle "p" box 
      ...
      if(sep > 1.0) sep = 1.0;
      if(sep < 0.0) sep = 0.0;
      real d_sep = lagrangian_fraction(sep);
  ...
  OPR("lagrangian_couple_interface.cpp");
  getchar();

}

/*-----------------------------------------------------------------------------+
 '$Id: lagrangian_couple_interface.cpp,v 1.2 2018/06/15 11:39:11 MinZhu Exp $'/ 
+-----------------------------------------------------------------------------*/
