!  generate mcr(script) file for Tecplot
   IMPLICIT NONE
   integer::ip,interval,nend,ntime,istep,nstep,ndigit,ispeed,nval,i,itmp
...
!--output 
   ...
   write(10,'(a)')"  READDATAOPTION = REPLACE"
   ...
   DO istep=1,nstep-1
      ...
      write(10,*)"READDATAOPTION = REPLACE"
