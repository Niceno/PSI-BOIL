...
/******************************************************************************/
void ScalarInt::bnd_update() {
/*-----------------------------------------------------------------------------+
|  updates boundary condition values for a scalar integer variable.            |
|                                                                              |
...
|                                                                              |
|  scalarint_exchange_all should take account of periodic condition            |
|    1st: phi.bnd_update();                                                    |
...
/******************************************************************************/
void ScalarInt::bnd_update_nowall() {
/*----------------------------------------------------+
|  same as above but without wall boundary condition  |
+----------------------------------------------------*/
...
/******************************************************************************/
void ScalarInt::bnd_update_symmetry() {
/*-----------------------------------+
|  only symmetry boundary condition  |
+-----------------------------------*/
