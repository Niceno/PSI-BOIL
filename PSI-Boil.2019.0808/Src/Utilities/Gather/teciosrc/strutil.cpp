...
static char      *FormatStringBuffer = NULL; static int        FormatStringBufferSize = FORMAT_BUFFER_SIZE; void ___1474() { if (FormatStringBuffer != NULL) free(FormatStringBuffer); FormatStringBuffer = NULL; } char *___4408(const char *Format, va_list     ___93) { char *___3357 = NULL; REQUIRE(VALID_REF(Format)); if (FormatStringBuffer == NULL) FormatStringBuffer = (char *)malloc(FormatStringBufferSize); if (FormatStringBuffer != NULL) {
 # if defined MSWIN
...
va_start(___93, Format);
 ...
 #pragma warning (pop)
 #endif
char *___3357 = ___4408(Format.c_str(), ___93); va_end(___93); ENSURE(VALID_REF(___3357) || ___3357 == NULL); return ___3357; } int ___1473(string&           ___417, ___4216  Format ...) { REQUIRE(!Format.___2033()); va_list ___93;
 #if defined(_MSC_VER)
 #pragma warning (push, 0)
 #pragma warning (disable:4840)
 #endif
...
char S[80+1]; MakeDebugRecord(___1393, ___2260, "duplicating", ___2698, S, 80); *___3431 = ___23(strlen(___2698) + 1, char, S);
 ...
 #     undef new
*___3431 = new(___1393, ___2260) char[strlen(___2698)+1];
