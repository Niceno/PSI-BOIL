...
va_start(___93, format);
 ...
 #pragma warning (pop)
 #endif
char* ___2430 = ___4408(format.c_str(), ___93); va_end(___93); if (___2430 == NULL) { cleanUp = ___1303; ___2430 = (char*)format.c_str(); } Message(___2430, ___2442); if (cleanUp) ___1528(___2430, "message"); } void ___4445(___4216 format, ...) { REQUIRE(!format.___2033()); ___372 cleanUp = ___4224; va_list  ___93;
 #if defined(_MSC_VER)
 #pragma warning (push, 0)
 #pragma warning (disable:4840)
 #endif
va_start(___93, format);
 ...
 #pragma warning (pop)
 #endif
char* ___2430 = ___4408(format.c_str(), ___93); va_end(___93); if (___2430 == NULL) { cleanUp = ___1303; ___2430 = (char*)format.c_str(); } Message(___2430, ___2445); if (cleanUp) ___1528(___2430, "message"); } namespace { void PostErrorMessage(___4216 format, va_list          ___93) { REQUIRE(!format.___2033()); ___372 cleanUp = ___4224; char* ___2453 = ___4408(format.c_str(), ___93); if (___2453 == NULL) { cleanUp = ___1303; ___2453 = (char*)format.c_str(); } postMessage(___2453, ___2441); if (cleanUp) ___1528(___2453, "messageString"); } } void ___4405(___4216 format, va_list          ___93) { REQUIRE(!format.___2033()); static ___372 InErrMsg = ___1303; if (!InErrMsg) { PostErrorMessage(format, ___93); } } void ___1175(___4216 format, ...) { REQUIRE(!format.___2033()); va_list ___93;
 #if defined(_MSC_VER)
 #pragma warning (push, 0)
 #pragma warning (disable:4840)
 #endif
