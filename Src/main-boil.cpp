...
int main(int argc, char ** argv) {
  ...
  |  monitoring points  |
  +--------------------*/
  Location m0("m0", dom, 52, NY/2, 68);  // 4 cell above wall
  // x~0.001
  Rack r1("r1", dom, 52, Range<int>(1,NY), Range<int>(1,NZA));
  ...
  // x~0.003
  //Rack r2("r2", dom, 154, Range<int>(1,NY), Range<int>(1,NZA));
  Rack r2("r2", dom, 54, Range<int>(1,NY), Range<int>(1,NZA));
  std::cout<<"Rack r2.done\n ";
  ...
  // x~0.005
  //Rack r3("r3", dom, 256, Range<int>(1,NY), Range<int>(1,NZA));
  Rack r3("r3", dom, 56, Range<int>(1,NY), Range<int>(1,NZA));
  ...
  // x~0.007
  //Rack r4("r4", dom, 359, Range<int>(1,NY), Range<int>(1,NZA));
  Rack r4("r4", dom, 59, Range<int>(1,NY), Range<int>(1,NZA));
  ...
  // x~0.009
  //Rack r5("r5", dom, 461, Range<int>(1,NY), Range<int>(1,NZA));
  Rack r5("r5", dom, 61, Range<int>(1,NY), Range<int>(1,NZA));
  ...
  const real tint2 = 2.0e-6; // time interval for monitoring rack
