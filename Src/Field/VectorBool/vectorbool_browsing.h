...
#ifndef BROWSING_VECTORBOOL_H
#define BROWSING_VECTORBOOL_H
...
/*-----------------------------------------------------------------------------+
 '$Id: vectorbool_browsing.h,v 1.1 2014/02/04 08:20:58 sato Exp $'/
+-----------------------------------------------------------------------------*/
