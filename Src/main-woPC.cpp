...
int main(int argc, char ** argv) {
  ...
  +--------------------*/
  // find I
  real Xr1=0.001, Xr2=0.003, Xr3=0.005, Xr4=0.007, Xr5=0.009;
  ...
  boil::oout<<"main:Ir1,Ir2,Ir3,Ir4,Ir5="<<Ir1<<" "<<Ir2<<" "<<Ir3<<" "<<Ir4<<" "<<Ir5<<"\n";
  ...
  const real tint2 = 2.0e-5; // time interval for monitoring rack
  const int  nint = 2000;   // time interval for bck-output
