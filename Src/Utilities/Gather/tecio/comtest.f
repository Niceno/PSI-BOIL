...
C 
      I = TECINI110('DATASET WITH 1 ORDERED ZONE, '//
...
C  
      VIsDouble = 1
      I = TECINI110('DATASET WITH ONE I-ORDERED ZONE'//NULCHAR,
     &              'X Y'//NULCHAR,
     &              'line.plt'//NULCHAR,
     &              '.'//NULCHAR,
     &               Debug,
...
C  
      ...
      StrandID = 1
      ParentZn = 0
	I = TECZNE110('Ordered Zone 1'//NULCHAR,
     &               0, ! ZONETYPE
     &               IMax,
     &               JMax,
     &               KMax,
...
C  
      III = IMax*JMax
      I   = TECDAT110(III,X,DIsDouble)
      I   = TECDAT110(III,Y,DIsDouble)
      I   = TECDAT110(III,P,DIsDouble)
...
C  
      ...
      SolTime = 0.0
      StrandID = 0
      I = TECZNE110('XY Line plot'//NULCHAR,
     &              0,
     &              IMax,
     &              JMax,
     &              KMax,
...
C  
      DIsDouble = 1
      III = IMax
      I   = TECDAT110(III,XLDummy,DIsDouble)
      I   = TECDAT110(III,YLDummy,DIsDouble)
...
C  
      ...
      SolTime   = 10.0
      StrandID  = 2
      I = TECZNE110('Finite Zone 1'//NULCHAR,
     &              3,  ! FEQUADRILATERAL
     &              NPts,
     &              NElm,
     &              KMax,
...
C
      ...
      SharingZone(2) = 1
      SharingZone(3) = 0
      I = TECZNE110('Ordered Zone 2'//NULCHAR,
     &              0,  ! ORDERED
     &              IMax,
     &              JMax,
     &              KMax,
...
C
      ...
      SharingZone(2) = 2
      SharingZone(3) = 0
      I = TECZNE110('Finite Zone 2'//NULCHAR,
     &              3,  ! FEQUADRILATERAL
     &              NPts,
     &              NElm,
     &              KMax,
