 ...
 */
  I = TECINI110("DATASET WITH ONE ORDERED ZONE AND ONE FE-QUAD ZONE OVER 2 TIME STEPS",
                "X Y P",
                "field.plt",
                ".",
                &Debug,
 ...
 */
  VIsDouble = 1;
  I = TECINI110("DATASET WITH ONE I-ORDERED ZONE",
                "X Y",
                "line.plt",
                ".",
                &Debug,
 ...
 */
  DIsDouble = 1;
  III = IMax;
  I   = TECDAT110(&III,(float *)&XL[0],&DIsDouble);
  I   = TECDAT110(&III,(float *)&YL[0],&DIsDouble);
