...
integer(c_int32_t) function  tecZoneCreateFEMixed( &  
    fileHandle, &  
    zoneTitle, &  
    numNodes, &  
    numSections, &  
    ...
    faceNeighborMode, &  
    zone) &  
    bind(c, name="tecZoneCreateFEMixed")
    use iso_c_binding
    implicit none
    type(c_ptr), value, intent(in)         :: fileHandle
    character(c_char), intent(in)          :: zoneTitle(*)
    integer(c_int64_t), value, intent(in)  :: numNodes
    integer(c_int32_t), value, intent(in)  :: numSections
    integer(c_int32_t), intent(in)         :: cellShapePerSection(*)
    integer(c_int32_t), intent(in)         :: gridOrderPerSection(*)
    integer(c_int32_t), intent(in)         :: basisFnPerSection(*)
    integer(c_int64_t), intent(in)         :: numElementsPerSection(*)
    integer(c_int32_t), intent(in)         :: varTypes(*)
    integer(c_int32_t), intent(in)         :: shareVarFromZone(*)
    integer(c_int32_t), intent(in)         :: valueLocations(*)
    integer(c_int32_t), intent(in)         :: passiveVarList(*)
    ...
    integer(c_int32_t), value, intent(in)  :: faceNeighborMode
    integer(c_int32_t), intent(out)        :: zone
end function tecZoneCreateFEMixed
...
integer(c_int32_t) function tecFEMixedPartitionCreate32( &
    fileHandle, &
    zone, &
    partition, &
    numNodes, &
    ...
    ghostCells) &
    bind(c, name="tecFEMixedPartitionCreate32")
    use iso_c_binding
    implicit none
    type(c_ptr), value, intent(in)        :: fileHandle
    integer(c_int32_t), value, intent(in) :: zone
    integer(c_int32_t), value, intent(in) :: partition
    integer(c_int64_t), value, intent(in) :: numNodes
    integer(c_int64_t), intent(in)        :: numCellsPerSection(*)
    integer(c_int64_t), value, intent(in) :: numGhostNodes
    integer(c_int32_t), intent(in)        :: ghostNodes(*)
    integer(c_int32_t), intent(in)        :: neighborPartitions(*)
    integer(c_int32_t), intent(in)        :: neighborPartitionNodes(*)
    integer(c_int64_t), intent(in)        :: numGhostCellsPerSection(*)
    integer(c_int32_t), intent(in)        :: ghostCells(*)
end function tecFEMixedPartitionCreate32

integer(c_int32_t) function tecFEMixedPartitionCreate64( &
    fileHandle, &
    zone, &
    partition, &
    numNodes, &
    ...
    numGhostCellsPerSection, &
    ghostCells) &
    bind(c, name="tecFEMixedPartitionCreate64")
    use iso_c_binding
    implicit none
    type(c_ptr), value, intent(in)        :: fileHandle
    integer(c_int32_t), value, intent(in) :: zone
    ...
    integer(c_int64_t), intent(in)        :: numGhostCellsPerSection(*)
    integer(c_int64_t), intent(in)        :: ghostCells(*)
end function tecFEMixedPartitionCreate64
...
integer(c_int32_t) function tecznefemixed142( &
  ZoneTitle, &
  NumNodes, &
  NumSections, &
  CellShapePerSection, &
  ...
  ShareVarFromZone, &
  ShareConnectivityFromZone) &
  bind (c, name="tecznefemixed142")
  use iso_c_binding
  implicit none
  character(c_char), intent(in)  :: ZoneTitle(*)
  integer(c_int64_t), intent(in) :: NumNodes
  integer(c_int32_t), intent(in) :: NumSections
  integer(c_int32_t), intent(in) :: CellShapePerSection(*)
  integer(c_int32_t), intent(in) :: GridOrderPerSection(*)
  integer(c_int32_t), intent(in) :: BasisFnPerSection(*)
  integer(c_int64_t), intent(in) :: NumElementsPerSection(*)
