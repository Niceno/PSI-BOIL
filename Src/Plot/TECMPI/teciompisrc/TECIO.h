...
EXTERNC tecio_API int32_t tecZoneCreateFEMixed(
    void*          fileHandle,
    char const*    zoneTitle,
    int64_t        numNodes,
    int32_t        numSections,
    int32_t const* cellShapePerSection,
    int32_t const* gridOrderPerSection,
    int32_t const* basisFnPerSection,
    int64_t const* numElementsPerSection,
    int32_t const* varTypes,
    int32_t const* shareVarFromZone,
    int32_t const* valueLocations,
    int32_t const* passiveVarList,
...
// Deprecated: Tecplot 2020r1 and later no longer uses ParentZone
...
EXTERNC tecio_API int32_t tecFEMixedPartitionCreate32(
    void*          fileHandle,
    int32_t        zone,
    int32_t        partition,
    int64_t        numNodes,
    int64_t const* numCellsPerSection,  // number of cells per section within the partition
    int64_t        numGhostNodes,
    int32_t const* ghostNodes,
    int32_t const* neighborPartitions,
    int32_t const* neighborPartitionNodes,
    int64_t const* numGhostCellsPerSection, // number of ghost cells per section
    int32_t const* ghostCells); // flat array containing ghost cells from each section, back to back

EXTERNC tecio_API int32_t tecFEMixedPartitionCreate64(
    void*          fileHandle,
    int32_t        zone,
    int32_t        partition,
    int64_t        numNodes,
    ...
    int64_t const* neighborPartitionNodes,
    int64_t const* numGhostCellsPerSection, // number of ghost cells per section
    int64_t const* ghostCells); // flat array containing ghost cells from each section, back to back
...
#  define TECZNEFEMIXED142 tecznefemixed142
...
#  define TECFEMIXEDPTN142 tecfemixedptn142
...
/*
 * Added the FEMixed zone type in October, 2022 which consists of sections
 * of different, possibly high-order, cell types.
 * (SZL only)
 */
EXTERNC tecio_API INTEGER4 TECZNEFEMIXED142(
    char const*     ZoneTitle,
...
EXTERNC tecio_API INTEGER4 TECFEMIXEDPTN142(
...
EXTERNC tecio_API INTEGER4 TECINI142(
    char const*     Title,
...
EXTERNC tecio_API INTEGER4 TECZNE142(
    char const*     ZoneTitle,
...
EXTERNC tecio_API int32_t TECPOLYZNE142(
    char const*     ZoneTitle,
    INTEGER4 const* ZoneType,
...
EXTERNC tecio_API INTEGER4 TECDAT142(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC tecio_API INTEGER4 TECDATD142(
    INTEGER4 const* N,
    double const*   FieldData);

EXTERNC tecio_API INTEGER4 TECDATF142(
    INTEGER4 const* N,
    float const*    FieldData);

EXTERNC tecio_API INTEGER4 TECNOD142(INTEGER4 const* NData);

EXTERNC tecio_API INTEGER4 TECNODE142(
    INTEGER4 const* N,
    INTEGER4 const* NData);

EXTERNC tecio_API INTEGER4 TECFLUSH142(
    INTEGER4 const* NumZonesToRetain,
    INTEGER4 const* ZonesToRetain);

EXTERNC tecio_API INTEGER4 TECEND142(void);

EXTERNC tecio_API INTEGER4 TECLAB142(char const* S);

EXTERNC tecio_API INTEGER4 TECUSR142(char const* S);

EXTERNC tecio_API INTEGER4 TECGEO142(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
...
EXTERNC tecio_API INTEGER4 TECTXT142(
...
EXTERNC tecio_API INTEGER4 TECFIL142(INTEGER4 const* F);

EXTERNC tecio_API void TECFOREIGN142(INTEGER4 const* OutputForeignByteOrder);

EXTERNC tecio_API INTEGER4 TECAUXSTR142(
    char const* Name,
    char const* Value);

EXTERNC tecio_API INTEGER4 TECZAUXSTR142(
    char const* Name,
    char const* Value);

EXTERNC tecio_API INTEGER4 TECVAUXSTR142(
    INTEGER4 const* Var,
    char const*     Name,
    char const*     Value);

EXTERNC tecio_API INTEGER4 TECFACE142(INTEGER4 const* FaceConnections);

/**
 * DEPRECATED. Please use functions TECPOLYFACE142 and TECPOLYBCONN142 instead.
 */
EXTERNC tecio_API INTEGER4 TECPOLY142(
...
EXTERNC tecio_API INTEGER4 TECPOLYFACE142(
...
EXTERNC tecio_API INTEGER4 TECPOLYBCONN142(
...
/* Partition APIs (SZL only) */
EXTERNC tecio_API INTEGER4 TECFEPTN142(
    INTEGER4 const* partition,
    INTEGER4 const* numnodes,
    INTEGER4 const* numcells,
...
EXTERNC tecio_API INTEGER4 TECIJKPTN142(
    INTEGER4 const* partition,
    INTEGER4 const* imin,
    INTEGER4 const* jmin,
    INTEGER4 const* kmin,
...
/* MPI APIs (SZL only) */
EXTERNC tecio_API INTEGER4 TECMPIINIT142(
    void* communicator, /* MPI_Comm */
    INTEGER4 const* mainrank);

EXTERNC tecio_API INTEGER4 TECZNEMAP142(
    INTEGER4 const* npartitions,
    INTEGER4 const* ptnranks);

/* Internal test functions */
EXTERNC tecio_API INTEGER4 TECINTERNAL142(
    const char* command,
    INTEGER8*   value);
...
EXTERNC tecio_API INTEGER4 TECINI112(
    char const*     Title,
    char const*     Variables,
    char const*     FName,
    char const*     ScratchDir,
...
EXTERNC tecio_API INTEGER4 TECZNE112(
    char const*     ZoneTitle,
    INTEGER4 const* ZoneType,
    INTEGER4 const* IMxOrNumPts,
    INTEGER4 const* JMxOrNumElements,
...
EXTERNC tecio_API INTEGER4 TECDAT112(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC tecio_API INTEGER4 TECNOD112(INTEGER4 const* NData);

EXTERNC tecio_API INTEGER4 TECNODE112(
    INTEGER4 const* N,
    INTEGER4 const* NData);

EXTERNC tecio_API INTEGER4 TECEND112(void);

EXTERNC tecio_API INTEGER4 TECLAB112(char const* S);

EXTERNC tecio_API INTEGER4 TECUSR112(char const* S);

EXTERNC tecio_API INTEGER4 TECGEO112(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC tecio_API INTEGER4 TECTXT112(
    double const*   XOrThetaPos,
    double const*   YOrRPos,
    double const*   ZOrUnusedPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC tecio_API INTEGER4 TECFIL112(INTEGER4 const* F);

EXTERNC tecio_API void TECFOREIGN112(INTEGER4 const* OutputForeignByteOrder);

EXTERNC tecio_API INTEGER4 TECAUXSTR112(
    char const* Name,
    char const* Value);

EXTERNC tecio_API INTEGER4 TECZAUXSTR112(
    char const* Name,
    char const* Value);

EXTERNC tecio_API INTEGER4 TECVAUXSTR112(
    INTEGER4 const* Var,
    char const*     Name,
    char const*     Value);

EXTERNC tecio_API INTEGER4 TECFACE112(INTEGER4 const* FaceConnections);

EXTERNC tecio_API INTEGER4 TECPOLY112(
    INTEGER4 const* FaceNodeCounts,
    INTEGER4 const* FaceNodes,
    INTEGER4 const* FaceLeftElems,
    INTEGER4 const* FaceRightElems,
...
EXTERNC tecio_API INTEGER4 TECPOLYFACE112(
    INTEGER4 const* NumFaces,
    INTEGER4 const* FaceNodeCounts,
    INTEGER4 const* FaceNodes,
    INTEGER4 const* FaceLeftElems,
...
EXTERNC tecio_API INTEGER4 TECPOLYBCONN112(
    INTEGER4 const* NumBndryFaces,
    INTEGER4 const* FaceBndryConnectionCounts,
    INTEGER4 const* FaceBndryConnectionElems,
    INTEGER4 const* FaceBndryConnectionZones);
...
EXTERNC tecio_API INTEGER4 TECINI111(
    char const*     Title,
    char const*     Variables,
    char const*     FName,
    char const*     ScratchDir,
...
EXTERNC tecio_API INTEGER4 TECZNE111(
    char const*     ZoneTitle,
    INTEGER4 const* ZoneType,
    INTEGER4 const* IMxOrNumPts,
    INTEGER4 const* JMxOrNumElements,
...
EXTERNC tecio_API INTEGER4 TECDAT111(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC tecio_API INTEGER4 TECNOD111(INTEGER4 const* NData);

EXTERNC tecio_API INTEGER4 TECEND111(void);

EXTERNC tecio_API INTEGER4 TECLAB111(char const* S);

EXTERNC tecio_API INTEGER4 TECUSR111(char const* S);

EXTERNC tecio_API INTEGER4 TECGEO111(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC tecio_API INTEGER4 TECTXT111(
    double const*   XOrThetaPos,
    double const*   YOrRPos,
    double const*   ZOrUnusedPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC tecio_API INTEGER4 TECFIL111(INTEGER4 const* F);

EXTERNC tecio_API void TECFOREIGN111(INTEGER4 const* OutputForeignByteOrder);

EXTERNC tecio_API INTEGER4 TECAUXSTR111(
    char const* Name,
    char const* Value);

EXTERNC tecio_API INTEGER4 TECZAUXSTR111(
    char const* Name,
    char const* Value);

EXTERNC tecio_API INTEGER4 TECVAUXSTR111(
    INTEGER4 const* Var,
    char const*     Name,
    char const*     Value);

EXTERNC tecio_API INTEGER4 TECFACE111(INTEGER4 const* FaceConnections);

EXTERNC tecio_API INTEGER4 TECPOLY111(
    INTEGER4 const* FaceNodeCounts,
    INTEGER4 const* FaceNodes,
    INTEGER4 const* FaceLeftElems,
    INTEGER4 const* FaceRightElems,
...
EXTERNC tecio_API INTEGER4 TECINI110(
    char const*     Title,
    char const*     Variables,
    char const*     FName,
    char const*     ScratchDir,
...
EXTERNC tecio_API INTEGER4 TECZNE110(
    char const*     ZoneTitle,
    INTEGER4 const* ZoneType,
    INTEGER4 const* IMxOrNumPts,
    INTEGER4 const* JMxOrNumElements,
...
EXTERNC tecio_API INTEGER4 TECDAT110(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC tecio_API INTEGER4 TECNOD110(INTEGER4 const* NData);

EXTERNC tecio_API INTEGER4 TECEND110(void);

EXTERNC tecio_API INTEGER4 TECLAB110(char const* S);

EXTERNC tecio_API INTEGER4 TECUSR110(char const* S);

EXTERNC tecio_API INTEGER4 TECGEO110(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC tecio_API INTEGER4 TECTXT110(
    double const*   XOrThetaPos,
    double const*   YOrRPos,
    double const*   ZOrUnusedPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC tecio_API void TECFOREIGN110(INTEGER4 const* OutputForeignByteOrder);

EXTERNC tecio_API INTEGER4 TECFIL110(INTEGER4 const* F);

EXTERNC tecio_API INTEGER4 TECAUXSTR110(
    char const* Name,
    char const* Value);

EXTERNC tecio_API INTEGER4 TECZAUXSTR110(
    char const* Name,
    char const* Value);

EXTERNC tecio_API INTEGER4 TECVAUXSTR110(
    INTEGER4 const* Var,
    char const*     Name,
    char const*     Value);

EXTERNC tecio_API INTEGER4 TECFACE110(INTEGER4 const* FaceConnections);
...
EXTERNC tecio_API INTEGER4 TECINI100(
    char const*     Title,
    char const*     Variables,
    char const*     FName,
    char const*     ScratchDir,
...
EXTERNC tecio_API INTEGER4 TECZNE100(
    char const*     ZoneTitle,
    INTEGER4 const* ZoneType,
    INTEGER4 const* IMxOrNumPts,
    INTEGER4 const* JMxOrNumElements,
...
EXTERNC tecio_API INTEGER4 TECDAT100(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC tecio_API INTEGER4 TECNOD100(INTEGER4 const* NData);

EXTERNC tecio_API INTEGER4 TECEND100(void);

EXTERNC tecio_API INTEGER4 TECLAB100(char const* S);

EXTERNC tecio_API INTEGER4 TECUSR100(char const* S);

EXTERNC tecio_API INTEGER4 TECGEO100(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC tecio_API INTEGER4 TECTXT100(
    double const*   XOrThetaPos,
    double const*   YOrRPos,
    double const*   ZOrUnusedPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC tecio_API INTEGER4 TECFIL100(INTEGER4 const* F);

EXTERNC tecio_API void TECFOREIGN100(INTEGER4 const* OutputForeignByteOrder);

EXTERNC tecio_API INTEGER4 TECAUXSTR100(
    char const* Name,
    char const* Value);

EXTERNC tecio_API INTEGER4 TECZAUXSTR100(
    char const* Name,
    char const* Value);

EXTERNC tecio_API INTEGER4 TECVAUXSTR100(
    INTEGER4 const* Var,
    char const*     Name,
    char const*     Value);

EXTERNC tecio_API INTEGER4 TECFACE100(INTEGER4 const* FaceConnections);

/* Old V9 functions retained for backward compatibility */

EXTERNC tecio_API INTEGER4 TECINI(
    char const*     Title,
    char const*     Variables,
    char const*     FName,
    char const*     ScratchDir,
...
EXTERNC tecio_API INTEGER4 TECZNE(
    char const*     ZoneTitle,
    INTEGER4 const* IMx,
    INTEGER4 const* JMx,
    INTEGER4 const* KMx,
...
EXTERNC tecio_API INTEGER4 TECDAT(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC tecio_API INTEGER4 TECNOD(INTEGER4 const* NData);

EXTERNC tecio_API INTEGER4 TECEND(void);

EXTERNC tecio_API INTEGER4 TECLAB(char const* S);

EXTERNC tecio_API INTEGER4 TECUSR(char const* S);

EXTERNC tecio_API INTEGER4 TECGEO(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC tecio_API INTEGER4 TECTXT(
    double const*   XPos,
    double const*   YPos,
    INTEGER4 const* PosCoordMode,
    INTEGER4 const* AttachToZone,
...
EXTERNC tecio_API INTEGER4 TECFIL(INTEGER4 const* F);
