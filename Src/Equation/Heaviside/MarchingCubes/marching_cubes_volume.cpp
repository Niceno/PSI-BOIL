...
/******************************************************************************/
real MarchingCubes::volume(const int i, const int j, const int k){
/***************************************************************************//**
...
*******************************************************************************/
  ...
  for (int m=0; m<=7; m++){
     ...
     * should not matter? Cf. phasechange_marching_cubes.cpp */
#endif
  ...
  if (volume > 1.0) {
    boil::oout << "marching_cubes::volume warning! color out of bounds at: "
               << i << " " << j << " " << k << " " << volume <<"\n";
    volume = 1.0;
  }
  if (volume < 0.0) {
