...
*******************************************************************************/
void Enthalpy::new_time_step(const Scalar * diff_eddy) {
  if( !solid() ) 
    new_time_step(flu->cp(), NULL,diff_eddy);
  else
    new_time_step(flu->cp(), sol->cp(), diff_eddy);
}
...
*******************************************************************************/
void Enthalpy::new_time_step(const Property * f_prop, const Property * s_prop,
