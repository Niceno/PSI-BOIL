...
/******************************************************************************/
void ColorCIP::bdcurv(const Scalar & sca, const real & theta) {
/***************************************************************************//**
...
*******************************************************************************/
  ...
  +---------------------------------------------*/
  for(int i=1; i<=nmag.ei()+1; i++) {
    for(int j=1; j<=nmag.ej()+1; j++) {
      for(int k=1; k<=nmag.ek()+1; k++) {
        nx[i][j][k] = nx[i][j][k]/nmag[i][j][k];
        ny[i][j][k] = ny[i][j][k]/nmag[i][j][k];
        nz[i][j][k] = nz[i][j][k]/nmag[i][j][k];
      }
    }
  }
...
/*-----------------------------------------------------------------------------+
 '$Id: colorcip_bdcurv.cpp,v 1.2 2009/11/12 12:15:47 sato Exp $'/
+-----------------------------------------------------------------------------*/
