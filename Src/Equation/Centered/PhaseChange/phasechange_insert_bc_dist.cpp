...
/******************************************************************************/
void PhaseChange::insert_bc_dist(Scalar & val) {
/***************************************************************************//**
    ...
    if( val.bc().type(b) == BndType::neumann()
      ...
      if(d != Dir::undefined()) {
        ...
        if(d == Dir::imin() || d == Dir::imax()){
          ...
          //std::cout<<val.bc().at(b).si()<<" "<<val.bc().at(b).ei()<<"\n";
          //std::cout<<jst<<" "<<jed<<" "<<kst<<" "<<ked<<"\n";
        }
...
/*-----------------------------------------------------------------------------+
 '$Id: phasechange_insert_bc_dist.cpp,v 1.3 2015/01/05 17:21:45 sato Exp $'/
+-----------------------------------------------------------------------------*/
