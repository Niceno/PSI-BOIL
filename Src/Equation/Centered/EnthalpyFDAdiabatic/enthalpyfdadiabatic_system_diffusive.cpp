...
*******************************************************************************/
void EnthalpyFDAdiabatic::create_system_diffusive(const Scalar * diff_eddy) {
  ...
  if( !solid() ) {
    ...
    for_ijk(i,j,k) {
      ...
      A.c[i][j][k] += tscn * lc * vol * 2.0 / (xm*xp) - tscn * lc * vol * 2.0 / (xm*(xm+xp)) * (1.0 - aflagm) - tscn * lc * vol * 2.0 / (xp*(xm+xp)) * (1.0 - aflagp); //shono edit
    ...
    for_ijk(i,j,k) {
      ...
      A.c[i][j][k] += tscn * lc * vol * 2.0 / (ym*yp) - tscn * lc * vol * 2.0 / (ym*(ym+yp)) * (1.0 -aflagm) - tscn * lc * vol * 2.0 / (yp*(ym+yp)) * (1.0 - aflagp); //shono edit
    ...
    for_ijk(i,j,k) {
      ...
      A.c[i][j][k] += tscn * lc * vol * 2.0 / (zm*zp) - tscn * lc * vol * 2.0 / (zm*(zm+zp)) * (1.0 - aflagm) - tscn * lc * vol * 2.0 / (zp*(zm+zp)) * (1.0 - aflagp); //shono edit
