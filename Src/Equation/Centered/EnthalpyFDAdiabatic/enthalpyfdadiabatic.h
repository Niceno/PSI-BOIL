#ifndef ENTHALPYFDADIABATIC_H
#define ENTHALPYFDADIABATIC_H
...
//            //
////////////////
class EnthalpyFDAdiabatic : public Centered {
  public:
    //! Global constructor.
    /*!
    ...
    */
    EnthalpyFDAdiabatic(const Scalar & phi, 
               const Scalar & f,
               const Scalar & clr,
               const Vector & u,
               Times & t,
    ...
    void set_turbP(real a){
      turbP=a;
      boil::oout<<"EnthalpyFDAdiabatic:turbP= "<<turbP<<"\n";
    }
