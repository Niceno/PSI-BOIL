...
/******************************************************************************/
void CIPCSL2::ib_norm(const Scalar & sca) {
/***************************************************************************//**
...
/******************************************************************************/
void CIPCSL2::ib_norm_cal(const int cc, const int i, const int j, const int k){
...
/******************************************************************************/
void CIPCSL2::nib(const real & nwx, const real & nwy, const real & nwz
...
#endif
/*-----------------------------------------------------------------------------+
 '$Id: cipcsl2_ib_norm.cpp,v 1.1 2014/02/04 08:24:40 sato Exp $'/
+-----------------------------------------------------------------------------*/
